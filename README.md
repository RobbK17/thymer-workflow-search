...
- **Autocomplete** — Colon suggestions: after **`OR`** / **`AND`** with **no** space before **`:`**, inserting **`has:`** / **`-has:`** is prefixed with a **space** so picks do not glue to the keyword (e.g. **`ORhas:link`**).
